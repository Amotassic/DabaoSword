...
public class DabaoSwordCommand {
    ...
    private static final MutableText info = Text.translatable("dabaosword.help.info").formatted(Formatting.AQUA).styled(style -> style.withClickEvent(new ClickEvent.SuggestCommand("/dabaosword info ")).withHoverEvent(new HoverEvent.ShowText(Text.translatable("dabaosword.help.info_hover")))),
