...
public interface ModTools {
    ...
    default void gainMaxHp(LivingEntity entity, int hp) {
        EntityAttributeModifier AttributeModifier = new EntityAttributeModifier(UUID.fromString("b29c34f3-1450-48ff-ab28-639647e11862"), "Max Hp", hp, EntityAttributeModifier.Operation.ADD_VALUE);
