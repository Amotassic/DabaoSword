...
public class ModEntity {
    public static final EntityType<XuyouEntity> XUYOU = Registry.register(Registries.ENTITY_TYPE, Identifier.of("dabaosword", "xuyou"), EntityType.Builder.create(XuyouEntity::new, SpawnGroup.MONSTER).dimensions(0.6f, 1.8f).build("xuyou"));
