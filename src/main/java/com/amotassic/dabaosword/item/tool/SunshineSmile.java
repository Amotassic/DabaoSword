...
public class SunshineSmile extends Item implements Equipment {
    public SunshineSmile() {super(new Item.Settings().maxDamage(999).rarity(Rarity.UNCOMMON).component(DataComponentTypes.UNBREAKABLE, new UnbreakableComponent(true)));}
