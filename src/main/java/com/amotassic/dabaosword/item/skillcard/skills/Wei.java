...
public class Wei {
    ...
    public static class Daoshu extends SkillItem implements DabaoSwordCommand.CSkill {
        ...
        public void triggerSkill(LivingEntity entity, Skill skill, LivingEntity target, int value) {
            ...
            if (value == 0) {
                user.sendMessage(Text.translatable("select_a_suit", daoshuText(user, tar, Suit.Heart), daoshuText(user, tar, Suit.Diamond), daoshuText(user, tar, Suit.Spade), daoshuText(user, tar, Suit.Club)));
                return;
            }
            voice(user, this);
            ...
            user.sendMessage(message); tar.sendMessage(message);
            ...
            if (c.suit.ordinal() + 1 == value) {
                ...
                tar.damage(user.getDamageSources().mobAttack(user), 6);
            } else skill.setCD(60);
        }
    ...
    public static class Gongao extends SkillItem {
        ...
        public Multimap<RegistryEntry<EntityAttribute>, EntityAttributeModifier> getModifiers(ItemStack stack, SlotReference slot, LivingEntity entity, Identifier slotIdentifier) {
            ...
            modifiers.put(EntityAttributes.GENERIC_MAX_HEALTH, new EntityAttributeModifier(slotIdentifier, s(stack).getTag(), EntityAttributeModifier.Operation.ADD_VALUE));
            return modifiers;
        }
    ...
    public static class Luoyi extends SkillItem {
        ...
        public Multimap<RegistryEntry<EntityAttribute>, EntityAttributeModifier> getModifiers(ItemStack stack, SlotReference slot, LivingEntity entity, Identifier slotIdentifier) {
            ...
            modifiers.put(EntityAttributes.GENERIC_ATTACK_DAMAGE, new EntityAttributeModifier(slotIdentifier, luoyi, EntityAttributeModifier.Operation.ADD_VALUE));
            return modifiers;
        }
    ...
    public static class Shensu extends SkillItem {
        ...
        public Multimap<RegistryEntry<EntityAttribute>, EntityAttributeModifier> getModifiers(ItemStack stack, SlotReference slot, LivingEntity entity, Identifier slotIdentifier) {
            ...
            modifiers.put(EntityAttributes.GENERIC_MOVEMENT_SPEED, new EntityAttributeModifier(slotIdentifier, d, EntityAttributeModifier.Operation.ADD_MULTIPLIED_TOTAL));
            return modifiers;
        }
