...
public class ModItems {
    ...
    public static final RegistryEntry<StatusEffect> BINGLIANG = register("bingliang",
            new BingliangEffect(StatusEffectCategory.HARMFUL, 0x46F732).addAttributeModifier(EntityAttributes.GENERIC_ATTACK_DAMAGE,"22653B89-116E-49DC-9B6B-9971489B5BE5",-4, EntityAttributeModifier.Operation.ADD_VALUE));
    //乐不思蜀效果
