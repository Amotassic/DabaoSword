...
public class ArrowRainItem extends CardItem {
    ...
    public TypedActionResult<ItemStack> use(World world, PlayerEntity playerEntity, Hand hand) {
        ...
        if (hand == Hand.MAIN_HAND && !world.isClient) {
            Text a = Text.of("a");
            ArrowEntity arrow1 = new ArrowEntity(world, playerEntity, stack);arrow1.setCustomName(a);
            ArrowEntity arrow2 = new ArrowEntity(world, playerEntity, stack);arrow2.setCustomName(a);
            ArrowEntity arrow3 = new ArrowEntity(world, playerEntity, stack);arrow3.setCustomName(a);
            ArrowEntity arrow4 = new ArrowEntity(world, playerEntity, stack);arrow4.setCustomName(a);
            ArrowEntity arrow5 = new ArrowEntity(world, playerEntity, stack);arrow5.setCustomName(a);
