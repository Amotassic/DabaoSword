...
public class SimpleMenuHandler extends ScreenHandler {
    ...
    public SimpleMenuHandler(int syncId, PlayerInventory inv, PacketByteBuf buf) {
        this(syncId, new SimpleInventory(20), inv.player.getWorld().getPlayerByUuid(buf.readUuid()));
    }
